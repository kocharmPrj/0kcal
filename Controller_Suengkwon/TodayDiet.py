...
class Ui_TodayDietWindow(object):
    def setMealFrame(self, addr, x, y):
        ...
        meal_name.setGeometry(QtCore.QRect(280, 66, 201, 25))
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(False)
        ...
        meal_info.setGeometry(QtCore.QRect(280, 150, 382, 51))
        ...
        item = QtWidgets.QTableWidgetItem()
        meal_info.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        ...
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        meal_info.setItem(0, 3, item)
        meal_info.horizontalHeader().setVisible(True)
        meal_info.horizontalHeader().setDefaultSectionSize(95)
        ...
        meal_vol.setGeometry(QtCore.QRect(280, 96, 101, 25))
        font = QtGui.QFont()
        font.setBold(False)
        ...
        meal_time.setGeometry(QtCore.QRect(370, 25, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(False)
        ...
        meal_is.setGeometry(QtCore.QRect(280, 20, 71, 25))
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(True)
    ...
    def setupUi(self, TodayDietWindow):
        ...
        self.scrollArea.setGeometry(QtCore.QRect(80, 100, 710, 471))
        ...
        self.total_info.setGeometry(QtCore.QRect(91, 609, 682, 85))
        ...
        self.total_info.setColumnCount(4)
        ...
        self.total_info.horizontalHeader().setDefaultSectionSize(170)
        ...
        self.total_info.verticalHeader().setDefaultSectionSize(31)
        ...
        self.progressBar_cal.setGeometry(QtCore.QRect(110, 662, 140, 24))
        ...
        self.progressBar_fat.setGeometry(QtCore.QRect(616, 662, 140, 23))
        self.progressBar_fat.setProperty("value", 45)
        self.progressBar_fat.setObjectName("progressBar_fat")
        self.progressBar_car = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar_car.setGeometry(QtCore.QRect(277, 662, 140, 23))
        self.progressBar_car.setProperty("value", 90)
        self.progressBar_car.setObjectName("progressBar_car")
        self.progressBar_pro = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar_pro.setGeometry(QtCore.QRect(446, 662, 140, 23))
        self.progressBar_pro.setProperty("value", 75)
        self.progressBar_pro.setObjectName("progressBar_pro")
        ...
        self.lineEdit.setGeometry(QtCore.QRect(360, 60, 121, 25))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, TodayDietWindow):
        ...
        item.setText(_translate("TodayDietWindow", "Carbohydrates[g]"))
        ...
        item.setText(_translate("TodayDietWindow", "Protein[g]"))
        item = self.meals_info[0].horizontalHeaderItem(3)
        item.setText(_translate("TodayDietWindow", "Fat[g]"))
        ...
        item.setText(_translate("TodayDietWindow", "73.9"))
        item = self.meals_info[0].item(0, 2)
        item.setText(_translate("TodayDietWindow", "23.2"))
        item = self.meals_info[0].item(0, 3)
        item.setText(_translate("TodayDietWindow", "13.2"))
        self.meals_info[0].setSortingEnabled(__sortingEnabled)
        ...
        item.setText(_translate("TodayDietWindow", "Protein[g]"))
        item = self.meals_info[1].horizontalHeaderItem(3)
        item.setText(_translate("TodayDietWindow", "Fat[g]"))
        __sortingEnabled = self.meals_info[1].isSortingEnabled()
        ...
        item.setText(_translate("TodayDietWindow", "23.2"))
        item = self.meals_info[1].item(0, 3)
        item.setText(_translate("TodayDietWindow", "13.2"))
        self.meals_info[1].setSortingEnabled(__sortingEnabled)
