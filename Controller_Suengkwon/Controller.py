...
class MainWindow(QMainWindow):
    ...
    def INMAIN_show_menu_dialog(self):
        try:
            menu_model_xml_path = "openvino.xml"
    ...
    def INMAIN_show_food_dialog(self):
        ...
        # self._food_dialog.ui.btnToStore.clicked.connect(self.INFOOD_store_food_data(self._food_dialog.ui.tmpPicInDialog, ''.join(map(str, self._food_dialog.ui.timeList)), self._food_dialog.ui.foodData))
